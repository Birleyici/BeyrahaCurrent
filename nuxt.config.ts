...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/kategori/genel': { redirect: '/' },  // Genel kategoriyi ana sayfaya yönlendirme
     ...
     // Eski linkler -> Yeni linkler yönlendirmesi
     ...
     '/urun/sultanbas-carsaf-takimi': { redirect: '/urun/sultanbas-carsaf-takimi--7', statusCode: 301 },
     '/urun/ic-pece-lacivert': { redirect: '/urun/ic-pece--lacivert-89', statusCode: 301 },
     '/urun/buyuk-boy-kolsuz-meryem-suflesi': { redirect: '/urun/buyuk-boy-kolsuz-meryem-suflesi--38', statusCode: 301 },
     ...
     '/urun/uc-katli-multi-sifon-pece': { redirect: '/urun/uc-katli-pece--33', statusCode: 301 },
     '/urun/iki-katli-super-soft-pece': { redirect: '/urun/iki-katli-pece--32', statusCode: 301 },
     '/urun/5-11-yas-cocuk-afgan-carsaf-takimi': { redirect: '/urun/sultanbas-afgan-carsaf-takimi-ozel-dikim--26', statusCode: 301 },
     '/urun/iki-katli-multi-sifon-pece': { redirect: '/urun/iki-katli-pece--32', statusCode: 301 },
     ...
     '/urun/kendinden-peceli-afgan-carsaf-takimi': { redirect: '/urun/kendinden-peceli-afgan-carsaf-takimi-ozel-dikim--25', statusCode: 301 },
     ...
     '/urun/buyuk-boy-sultanbas-kolsuz-sufle-kahverengi': { redirect: '/urun/buyuk-boy-sultanbas-kolsuz-sufle--37', statusCode: 301 },
     '/urun/orta-boy-sultanbas-oval-kesim-kolsuz-sufle-yesil': { redirect: '/urun/orta-boy-tek-katli-khimar-sufle--yesil-113', statusCode: 301 },
     '/urun/buyuk-boy-kolsuz-meryem-suflesi-lacivert': { redirect: '/urun/buyuk-boy-kolsuz-meryem-suflesi--lacivert-115', statusCode: 301 },
     '/urun/kendinden-peceli-tek-parca-suud-cilbabi': { redirect: '/urun/kendinden-peceli-tek-parca-suud-cilbabi-ozel-dikim--27', statusCode: 301 },
