...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    // Renk belirtilmeyen ürünler için siyah varyantlarına yönlendirme
      ...
      '/urun/bassiz-afgan-takimi-tunik-etek-takimi-kahverengi': { redirect: '/urun/bassiz-afgan-takimi-ozel-dikim--siyah-71', statusCode: 301 },
      '/urun/bassiz-afgan-takimi-tunik-etek-takimi-yesil': { redirect: '/urun/bassiz-afgan-takimi-ozel-dikim--siyah-71', statusCode: 301 },
