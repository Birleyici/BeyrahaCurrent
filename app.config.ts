...
ui: {
    ...
    selectMenu: {
      ...
      option: {
        base: 'cursor-default select-none relative py-2 pl-3 pr-9',
        rounded: 'rounded-lg',
        padding: 'px-3 py-2',
        size: {
          '2xs': 'text-xs',
        ...
        container: 'flex items-center justify-between gap-1',
        active: 'bg-orange-100 dark:bg-orange-900/30 text-orange-900 dark:text-orange-100',
        inactive: 'text-gray-700 dark:text-gray-300',
        selected: 'font-semibold bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400',
        disabled: 'cursor-not-allowed opacity-50',
        empty: 'text-sm text-gray-400 dark:text-gray-500 px-3 py-2',
        icon: {
      ...
      menu: 'bg-white dark:bg-gray-800 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700 rounded-lg py-1',
