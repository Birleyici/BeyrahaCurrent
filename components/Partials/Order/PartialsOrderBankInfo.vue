<template>
  <div class="relative space-y-2 rounded-md bg-tertiary-0 border border-secondary-500 p-pad-2 text-white">
    ...
    <div class="bg-secondary-400 rounded-md p-2 lg:flex justify-between">
      <div class="lg:flex justify-between lg:space-x-4">
        <div class="flex items-center space-x-2">
          <UIcon v-if="!copyIban" @click="copyIbanCode" name="i-heroicons-clipboard-document"
    ...
    <div class="bg-secondary-400 rounded-md p-2 lg:flex justify-between">
      <div class="lg:flex justify-between lg:space-x-4">
        <div class="flex items-center space-x-2">
          <UIcon v-if="!copyName" @click="copyAccountName" name="i-heroicons-clipboard-document"
            class="w-6 h-6 cursor-pointer" />
          <UIcon v-else name="i-heroicons-clipboard-document-check" class="w-6 h-6" />
          <b>HESAP ADI </b>
        </div>
