    ...
    <template #default="{ item, index, open }">
      ...
      <UButton color="gray" variant="ghost"
        ...
        <div class="flex items-center">
          <UIcon name="i-heroicons-trash" class="text-red-500" @click="deleteAttr(props.item.product_attribute_id)"></UIcon>
        ...
        <div class="mt-4">
          ...
          <div class="flex space-x-2">
            ...
            <div v-for="term in props.item.product_terms">
              <UiBadgesBadge @is-click="removeTerm(term, props.item.product_terms)" class="m-1">
                {{ term.term_name }}
              </UiBadgesBadge>
            </div>
          </div>
