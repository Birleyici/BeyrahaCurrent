<template>
    <article
        class="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-soft hover:shadow-medium transition-all duration-300">
        <!-- Header -->
