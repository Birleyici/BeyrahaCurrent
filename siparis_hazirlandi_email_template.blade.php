...
<head>
  ...
  <![endif]-->
    ...
    <title>Siparişiniz Hazırlandı - {{ $site_adi }}</title>
    <style type="text/css">
        table.container {
                    ...
                    <table style="width: 100%; background: linear-gradient(135deg, #f97316 0%, #ea580c 100%);">
                        <tr>
                            <td style="padding: 40px 30px; text-align: center;">
                                ...
                                <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 700; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">Siparişiniz Hazırlandı!</h1>
                                <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">Siparişiniz hazırlandı ve kargoya verilmeyi bekliyor</p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table style="width: 100%; background-color: #ffffff;">
                        <tr>
                            <td style="padding: 40px 30px;">
                                <h2 style="color: #f97316; margin: 0 0 15px; font-size: 24px; font-weight: 600;">Sayın {{ $musteri_adi }}, 👋</h2>
                                    ...
                                    <tr>
                                        <td style="background: #fef3e2; padding: 25px; border-radius: 8px; border-left: 4px solid #f97316;">
                                            <p style="margin: 0; color: #92400e; font-size: 16px; line-height: 1.7;">
                                                🎉 Harika haber! {{ $siparis_kodu }} numaralı siparişiniz hazırlandı ve kargoya verilmeyi bekliyor. En kısa sürede kargo firmasına teslim edeceğiz.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="background: #f8fafc; padding: 25px; border-radius: 8px; border: 1px solid #e2e8f0;">
                                            ...
                                            <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                                ...
                                                <span style="color: #64748b; margin-left: 10px; font-size: 14px;">{{ $siparis_tarihi }}</span>
                                            </div>
                                            <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                                <div style="width: 20px; height: 20px; background: #f97316; border-radius: 50%; margin-right: 15px; display: inline-flex; align-items: center; justify-content: center; color: white; font-size: 12px;">✓</div>
                                                <span style="color: #f97316; font-weight: 600;">Hazırlandı</span>
                                                <span style="color: #64748b; margin-left: 10px; font-size: 14px;">{{ $bugunku_tarih }}</span>
                                            </div>
                                            <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                                <div style="width: 20px; height: 20px; background: #f59e0b; border-radius: 50%; margin-right: 15px; display: inline-flex; align-items: center; justify-content: center; color: white; font-size: 12px;">3</div>
                                                <span style="color: #f59e0b; font-weight: 600;">Kargoya Verilecek</span>
                                            </div>
                                ...
                                <table style="width: 100%; margin: 30px 0;">
                                    <tr>
                                        <td style="background: #f8fafc; padding: 25px; border-radius: 8px; border: 1px solid #e2e8f0;">
                                            ...
                                            <p style="margin: 5px 0; color: #64748b;"><strong style="color: #1f2937;">Hazırlanma Tarihi:</strong> {{ $bugunku_tarih }}</p>
                                            <p style="margin: 5px 0; color: #64748b;"><strong style="color: #1f2937;">Sipariş Durumu:</strong> <span style="color: #f97316; font-weight: 600;">Hazırlandı</span></p>
                                            <p style="margin: 5px 0; color: #64748b;"><strong style="color: #1f2937;">Toplam Tutar:</strong> <span style="color: #f97316; font-weight: 600;">{{ number_format($siparis_genel_toplam, 2, ',', '.') }} {{ $para_birimi }}</span></p>
                                            <p style="margin: 5px 0; color: #64748b;"><strong style="color: #1f2937;">Tahmini Kargo Tarihi:</strong> <span style="color: #f59e0b; font-weight: 600;">Yarın</span></p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 100%; border-collapse: collapse; margin: 30px 0; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                                    <thead>
                                        <tr style="background: #f8fafc;">
                                            <th style="padding: 16px; text-align: left; font-weight: 600; color: #374151; border-bottom: 1px solid #e5e7eb;">🛒 Hazırlanan Ürünler</th>
                                    ...
                                    <tfoot>
                                        <tr style="background: #fef3e2;">
                                            ...
                                            <td style="padding: 16px; text-align: right; font-weight: 700; color: #f97316;">{{ number_format($siparis_genel_toplam, 2, ',', '.') }} {{ $para_birimi }}</td>
                                        </tr>
                                    </tfoot>
                                </table>
                                    ...
                                    <tr>
                                        <td style="background: #fef3e2; padding: 25px; border-radius: 8px; border-left: 4px solid #f97316;">
                                            ...
                                            <ul style="margin: 0; padding-left: 20px; color: #92400e;">
                                                <li style="margin-bottom: 8px;">📦 Siparişiniz hazırlandı ve kalite kontrolünden geçti</li>
                                                <li style="margin-bottom: 8px;">🚛 En geç yarın kargo firmasına teslim edilecek</li>
                                                <li style="margin-bottom: 8px;">📧 Kargoya verildiğinde takip numarası ile bilgilendirileceksiniz</li>
                                                <li style="margin-bottom: 8px;">⏰ Teslimat süresi kargoya verildikten sonra 1-3 iş günüdür</li>
                                ...
                                <p style="margin: 30px 0 10px; color: #64748b; font-size: 15px;">
                                    Siparişinizi hazırladığımız için teşekkür ederiz. Kargoya verildiğinde size haber vereceğiz.
                                </p>
                                <p style="margin: 0; color: #1f2937; font-weight: 600;">
                                    Saygılarımızla,<br>
                                    <span style="color: #f97316;">{{ $site_adi }} Ekibi</span> 💜
                                </p>
                            </td>
                        </tr>
                    </table>
